...
Das benutzerdefinierte Video-Tracking verwendet das [manuelle Link-Tracking mit benutzerdefiniertem Link-Code](https://docs.adobe.com/content/help/de-DE/media-analytics/using/measurement-options/cl-in-aa/cl-impl-guide.html) im `appMeasurement` in Analytics.
