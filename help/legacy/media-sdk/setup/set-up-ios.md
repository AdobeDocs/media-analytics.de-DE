...
Erfahren Sie, wie Sie die Streaming-Mediendienste für iOS-Geräte einrichten.
...
* **Implementieren von ADBMobile für iOS in Ihrer Anwendung**
Weitere Informationen zur Dokumentation zu Adobe Mobile SDK finden Sie unter [iOS SDK 4.x for Experience Cloud Solutions.](https://experienceleague.adobe.com/docs/mobile-services/ios/overview.html?lang=de)
...
1. Fügen Sie Ihr [heruntergeladenes](/help/getting-started/download-sdks.md) Medien-SDK zu Ihrem Projekt hinzu.
   ...
   1. Fügen Sie die Bibliothek zu Ihrem Projekt hinzu:
      ...
      ![Optionen auswählen](assets/choose-options_ios.png)
