...
* **Implementieren von `AppMeasurement` für JavaScript in Ihrer Medienanwendung**
Weitere Informationen zur Dokumentation zu Adobe Mobile SDK finden Sie unter [Analytics mit JavaScript implementieren.](https://experienceleague.adobe.com/docs/analytics/implementation/js/overview.html?lang=de)
...
1. Fügen Sie Ihre [heruntergeladene](/help/getting-started/download-sdks.md) Bibliothek zu Ihrem Projekt hinzu. Erstellen Sie aus Gründen der Übersichtlichkeit lokale Referenzen auf die Klassen.
   ...
   1. Referenzieren Sie `MediaSDK.min.js` auf allen Web-Seiten.
