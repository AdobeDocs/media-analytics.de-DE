...
| ----------- | ---------- | ------- |
| Mediensammlung: Integration mit Experience Edge (API und Mobile SDK) | Sie können jetzt die Experience Edge-API und das Mobile SDK verwenden, um Streaming-Medien zu implementieren. So können Sie personalisiertere Kampagnen erstellen und personalisiertere Inhalte bereitstellen, was zu mehr Tracking-Daten für die Berichterstellung führt.<p>Diese Verbesserung bietet eine einheitliche Erfassungsmethode für alle Lösungen, wie z. B. Customer Journey Analytics-Reporting, RT-CDP, AJO und Ereignisweiterleitung.  [Weitere Informationen](/help/implementation/implementation-edge.md) | 12. Mai 2023 |
