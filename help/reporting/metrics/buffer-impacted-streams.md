...
Das Medien-Backend legt `mediaReporting.qoeDataDetails.hasBufferImpactedStreams = true` das erste Mal fest, dass während der Sitzung ein `media.bufferStart` empfangen wird. Die Metrik wird beim Schließen-Aufruf gemeldet.
...
| Customer Journey Analytics | [`mediaReporting.qoeDataDetails.hasBufferImpactedStreams`](https://experienceleague.adobe.com/de/docs/experience-platform/xdm/data-types/qoe-data-details-reporting) |
