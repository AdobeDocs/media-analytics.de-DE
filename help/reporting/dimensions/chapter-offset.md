...
Der Kapitelversatz wird vom Player bei jedem `media.chapterStart` festgelegt.
...
| Customer Journey Analytics | [`mediaReporting.chapterDetails.offset`](https://experienceleague.adobe.com/de/docs/experience-platform/xdm/data-types/chapter-details-reporting) |
...
Jedes Element ist der ganzzahlige Versatzwert in Sekunden, der für `media.chapterStart` gemeldet wird.
