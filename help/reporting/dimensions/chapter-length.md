...
Die Kapitellänge wird vom Player bei jedem `media.chapterStart` festgelegt.
...
Jedes Element ist der ganzzahlige Längenwert in Sekunden, der für `media.chapterStart` gemeldet wird.
