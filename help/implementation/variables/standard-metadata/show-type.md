...
Verwenden Sie `MEDIA_VideoMetadataKeySHOW_TYPE` , um den Sendungstyp in den Standardmetadaten des Medienobjekts festzulegen, bevor Sie `mediaTrackSessionStart` aufrufen:
