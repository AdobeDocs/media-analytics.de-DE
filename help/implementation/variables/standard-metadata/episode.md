...
| **XDM-Sammlungsfeld** | [`mediaCollection.sessionDetails.episode`](https://experienceleague.adobe.com/de/docs/experience-platform/xdm/data-types/session-details-collection) |
