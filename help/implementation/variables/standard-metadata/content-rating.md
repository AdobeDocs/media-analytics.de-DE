...
| **XDM-Sammlungsfeld** | [`mediaCollection.sessionDetails.rating`](https://experienceleague.adobe.com/de/docs/experience-platform/xdm/data-types/session-details-collection) |
