...
Übergeben Sie die Inhaltslänge in Sekunden als drittes Argument für `ADBMobile.media.createMediaObject`:
...
Übergeben Sie die Inhaltslänge in Sekunden als drittes Argument für `adb_media_init_mediainfo`:
