...
Verwenden Sie die [Ereignisanfrage](../mc-api-ref/mc-api-events-req.md) für alle nachfolgenden Tracking-Aufrufe, nachdem Sie eine Sitzungs-ID mit der [Sitzungsanfrage“ &#x200B;](../mc-api-ref/mc-api-sessions-req.md) Geben Sie den Abspielkopfspeicherort und Zeitstempel, den Ereignistyp und alle optionalen Parameter, die Sie in den JSON-Hauptteil der Anfrage einschließen möchten, an.
