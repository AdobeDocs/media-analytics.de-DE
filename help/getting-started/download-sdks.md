...
| </br>**Web** | Adobe Analytics<p>Customer Journey Analytics</p><p>Adobe Journey Optimizer</p><p>Real-Time CDP</p> | Edge | Web - Experience Platform Edge |  | [Implementieren Sie die Streaming-Mediensammlung mit dem -Edge Network ](/help/implementation/edge/implementation-edge.md) <p>und</p><p>[Senden von Web-Daten an Edge mit Adobe Experience Platform Web SDK](/help/implementation/edge/edge-web-sdk.md)</p> | |
