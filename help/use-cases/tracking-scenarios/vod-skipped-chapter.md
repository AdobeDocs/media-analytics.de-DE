...
Dies ist dasselbe Szenario wie die [VOD-Wiedergabe mit einem Kapitel](/help/use-cases/tracking-scenarios/vod-one-chapter.md), mit der Ausnahme, dass der Benutzer in diesem Fall versucht, in dem Kapitel zu suchen, es dadurch überspringt und in den Hauptinhalt gelangt.
