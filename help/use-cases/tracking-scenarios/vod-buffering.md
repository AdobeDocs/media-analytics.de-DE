...
description: Sehen Sie sich ein in Beispiel für das Tracking von VOD-Inhalten mit dem Media SDK an.
...
Wenn nichts anderes angegeben ist, sind die Netzwerkaufrufe in diesem Szenario mit den Aufrufen im Szenario [VOD-Wiedergabe ohne Anzeigen](/help/use-cases/tracking-scenarios/vod-no-intrs-details.md) identisch.
