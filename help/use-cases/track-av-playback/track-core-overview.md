...
>[!TIP]
>
>Die Abspielleistenposition wird als Teil des Einrichtungs- und Konfigurationscodes festgelegt. Weitere Informationen zu `getCurrentPlayheadTime` finden Sie unter [Überblick: Allgemeine Implementierungsrichtlinien.](/help/implementation/media-sdk/media-sdk-overview.md)
