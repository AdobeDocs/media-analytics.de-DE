...
1. **Tracking-Ersteinrichtung**
   ...
   | `streamType` | string | [Stream-Typ](Link zu streamType-Konstanten) oder nicht leere Zeichenfolge zur Bezeichnung des Medienstreamtyps. |
   | `mediaType` | [MediaType](Link zu MediaType-Konstanten) | Medientyp (Audio oder Video). |
