---
seo-title: Mehrere parallele VOD-Tracker
...
This scenario is identical to the [VOD playback with no ads](../../sdk-implement/tracking-scenarios/vod-no-intrs-details.md) scenario, except there are two sessions that are running in parallel for two separate medias. Jede dieser Sitzungen verwendet eine eigene Instanz von `MediaHeartbeat`.

Wenn nichts anderes angegeben ist, sind die Netzwerkaufrufe mit denen im Szenario [VOD-Wiedergabe ohne Anzeigen](../../sdk-implement/tracking-scenarios/vod-no-intrs-details.md) identisch.
