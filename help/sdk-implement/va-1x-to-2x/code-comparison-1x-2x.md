...
* `MediaHeartbeatConfig.playerName` - Jetzt anstelle `MediaHeartbeatConfig` von `VideoPlayerPluginDelegate`
...
**Links zu den Beispielplayern 1. x und 2. x:**
...
Die folgenden Abschnitte enthalten Codevergleiche zwischen 1. x und 2. x, die Initialisierung, Core-Wiedergabe, Ad-Wiedergabe, Kapitelwiedergabe und einige zusätzliche Ereignisse.
